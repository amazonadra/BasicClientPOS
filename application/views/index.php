                    ...
                    <table id='carttable' class="table">
                      ...
                      <tbody class='hasil'>
                        ...
                        <tr class="pos">
                          ...
                          <td><b><input type="number" class="form-control col-md-3" name="bayar" size="6" id="inputbayar" required="required" value="0" min="0"></b></td>
                          <td></td>
                        </tr>
                      </tbody>
                    </table>
    ...
    $(function(){
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if (data.isi == 1) {
              ...
              $('#kembalian').modal();
              //$('#pendapatan').val('Rp. '+data.pendapatan);
            }else {
              alert(data.alert);
      ...
      $(document).on('click', '#tumbas', function(e){
        ...
        $.ajax({
          ...
          dataType: 'json',
          success: function(data){
            $('<iframe id="myframe">').attr('src','<?php echo site_url('invoice/index')?>'+'/'+data.id+'/'+value).appendTo('body');
            $(".resetitem").click();
            keluar();
          }
        });
